    ...
    <div className="dashboard-container">
      ...
      <div className="sidebar">
        ...
        <div
          ...
          style={{ marginTop: "auto", listStyle: "none", paddingLeft: "15px" }}
        >
          <li>🚪 Logout</li>
        </div>
      </div>
      ...
      <div className="main-content">
        ...
        <div style={{ marginBottom: "30px" }}>
          <h1
            style={{ fontSize: "28px", color: "#111827", margin: "0 0 8px 0" }}
          >
            Welcome back, Student! 👋
          </h1>
          <p style={{ color: "#6b7280", margin: 0 }}>
            How are you feeling today? Let's take care of your mental
            well-being.
          </p>
        </div>
        ...
        <div style={{ display: "flex", gap: "24px", alignItems: "flex-start" }}>
          ...
          <div className="card" style={{ flex: 1 }}>
            ...
            >
              Your mood tracking over the last 7 days.
            </p>
            ...
            <div style={{ marginTop: "24px" }}>
              ...
              <div style={{ display: "flex", gap: "12px" }}>
                <button
                  ...
                  style={{
                    fontSize: "24px",
                    background: selectedMood === "sad" ? "#fbcfe8" : "white",
                ...
                <button
                  ...
                  style={{
                    fontSize: "24px",
                    background:
                      selectedMood === "neutral" ? "#fbcfe8" : "white",
                    border: "1px solid #f9a8d4",
                    borderRadius: "50%",
                    padding: "8px",
                    cursor: "pointer",
                ...
                <button
                  ...
                  style={{
                    fontSize: "24px",
                    background: selectedMood === "happy" ? "#fbcfe8" : "white",
                    border: "1px solid #f9a8d4",
                    borderRadius: "50%",
                    padding: "8px",
                    cursor: "pointer",
