            ...
            <div style={styles.dashboardStatsCard}>
              ...
              <div style={{ ...styles.statsGrid, gridTemplateColumns: isMobile ? "1fr" : "1.5fr 1fr 1fr 1fr" }}>
                ...
                <div style={styles.metricTile}>
                    ...
                    <p style={styles.metricLabel}>Longest Run</p>
...
const styles = {
  ...
  backToDashBtn: { display: 'flex', alignItems: 'center', background: '#e0f2fe', color: '#0b63d3', padding: '12px 20px', borderRadius: '12px', border: '1px solid #bae6fd', fontSize: '14px', fontWeight: '600', cursor: 'pointer', textDecoration: 'none', boxShadow: '0 1px 2px 0 rgba(0, 0, 0, 0.05)', transition: 'background 0.2s' },
